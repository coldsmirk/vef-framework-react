...
import { kitConfig, localReactPlugin, localReactRules } from "./custom-react-rules";
...
const SOURCE_FILE_PATTERNS = ["**/*.ts", "**/*.tsx", "**/*.mts", "**/*.cts", "**/*.js", "**/*.jsx", "**/*.mjs", "**/*.cjs"];
const NON_TSX_FILE_PATTERNS = ["**/*.ts", "**/*.mts", "**/*.cts", "**/*.js", "**/*.jsx", "**/*.mjs", "**/*.cjs"];
const IGNORED_FILES = ["**/*.gen.ts"];

export function defineEslintConfig(...args: Parameters<typeof defineConfig>): ReturnType<typeof defineConfig> {
  return defineConfig(
    gitignore({ root: true, strict: true }),
    {
