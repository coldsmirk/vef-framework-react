...
function renderTitleField(apiClient: ApiClient, formLayout?: { layout: "horizontal" | "vertical" }) {
  render(
    <FormModal<PostValues> open defaultValues={{ title: "" }} formLayout={formLayout} title="新建">
      {formApi => (
  ...
  describe("close", () => {
    ...
    it("resets the form when closed so the next open starts from the new defaultValues", async () => {
      ...
      const { rerender } = render(
        <FormModal<PostValues> open defaultValues={{ title: "first" }} title="新建">
          <TitleField />
        </FormModal>,
        { apiClient }
      );
      ...
      rerender(
        <FormModal<PostValues> defaultValues={{ title: "first" }} title="新建">
          <TitleField />
        </FormModal>
      );

      rerender(
        <FormModal<PostValues> open defaultValues={{ title: "second" }} title="新建">
          <TitleField />
        </FormModal>
      );
