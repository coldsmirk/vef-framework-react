...
vi.mock("../_base/helpers/message", async importOriginal => {
  // eslint-disable-next-line @typescript-eslint/consistent-type-imports -- vitest's importOriginal type parameter requires an inline `typeof import(...)` to type the real module.
